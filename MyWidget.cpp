...
MyWidget::MyWidget()
{
    ...
    setpicture.setStyleSheet("QPushButton{background-color:rgba(80,80,80,0);border-radius:10px;border-color:rgb(0,0,0);border:0px groove gray;border-style: outset;}""QPushButton:hover{background-color:rgb(41,128,249);}""QPushButton:pressed{background-color:rgb(19,75,211)}");
